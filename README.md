...
The following tasks represent the curriculum for my internship. I will be implementing these sequentially to build a foundation in cryptography, software security, and network analysis.

## **Task 01: _Implement Caesar Cipher_**\
Develop a Python program that can encrypt and decrypt text using the Caesar Cipher algorithm. Users will be able to input a custom message and a shift value for processing.

## **Task 02: _Pixel Manipulation for Image Encryption_**\
Create a simple image encryption tool using pixel manipulation. The goal is to perform operations like swapping pixel values or applying mathematical operations to scramble and unscramble visual data.
